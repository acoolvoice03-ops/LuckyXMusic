...
import config
from LuckyXMusic import LOGGER, YouTube, Lucky
...
from LuckyXMusic.utils.formatters import check_duration, seconds_to_min, speed_converter
            ...
            if "live_" in queued:
                ...
                run = await Lucky.send_photo(
                    ...
                    caption=_["stream_1"].format(
                        f"https://t.me/{Lucky.username}?start=info_{videoid}",
                        title[:23],
                        check[0]["dur"],
                        user,
                    ),
                ...
                mystic = await Lucky.send_message(original_chat_id, _["call_7"])
                try:
